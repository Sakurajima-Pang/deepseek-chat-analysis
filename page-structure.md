...
> 更新: 2026-05-13  |  视口约定: 实际窗口大小（由用户手动最大化决定）
...
### sidebar-handle  — 收起的把手  <i>角色: 侧边栏收起时出现的替代操作区（鲸鱼图标 + 3个快捷按钮）</i>

| 状态 | 前置条件 | 特征 | 备注 |
|------|----------|------|------|
| 可见 | sidebar=收起 | classes=ca6d4be1, _5a20a69 | width=157 | childCount=2 | - |

### sidebar-handle-icon  — 展开图标(鲸鱼)  <i>角色: 展开图标（鲸鱼），点击侧边栏展开，功能与展开按钮重复</i>
...
### main-panel  — 主面板  <i>角色: 聊天内容展示区，位置在侧边栏右侧</i>
